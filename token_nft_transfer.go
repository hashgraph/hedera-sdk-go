...
func nftTransferFromProtobuf(pb *services.NftTransfer, networkName *NetworkName) TokenNftTransfer {
	if pb == nil {
		return TokenNftTransfer{}
	}
	return TokenNftTransfer{
...
func (transfer *TokenNftTransfer) toProtobuf() *services.NftTransfer {
