...
func (tx *Transaction[T]) buildScheduled() (*services.SchedulableTransactionBody, error) {
...
// create new transaction with transaction interface generic from concrete transaction generic
