...
var file_account_pending_airdrop_proto_goTypes = []interface{}{
...
func file_account_pending_airdrop_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_account_pending_airdrop_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountPendingAirdrop); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
