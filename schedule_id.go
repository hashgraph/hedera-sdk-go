...
func (id ScheduleID) ToSolidityAddress() string {
	return idToSolidityAddress(id.Shard, id.Realm, id.Schedule)
}

func (id ScheduleID) toProto() *proto.ScheduleID {
...
func scheduleIDFromProto(pb *proto.ScheduleID) ScheduleID {
	return ScheduleID{
