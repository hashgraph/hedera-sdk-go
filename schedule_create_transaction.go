...
func (transaction *ScheduleCreateTransaction) SetTransactionBody(dat []byte) *ScheduleCreateTransaction {
	transaction.requireNotFrozen()
	transaction.pb.TransactionBody = dat

	return transaction
}

func (transaction *ScheduleCreateTransaction) GetTransactionBody() []byte {
	return transaction.pb.TransactionBody
}
