...
func (builder ContractDeleteTransaction) SetMemo(memo string) ContractDeleteTransaction {
	return ContractDeleteTransaction{builder.TransactionBuilder.SetMemo(memo), builder.pb}
}
