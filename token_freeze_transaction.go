...
func (transaction *TokenFreezeTransaction) Execute(
	...
	if !transaction.IsFrozen() {
		_, err := transaction.FreezeWith(client)
		if err != nil {
			return TransactionResponse{}, errors.Wrap(err, "FreezeWith in Execution")
		}
	}
...
func (transaction *TokenFreezeTransaction) FreezeWith(client *Client) (*TokenFreezeTransaction, error) {
	...
	if err := transaction.initTransactionID(client); err != nil {
		return transaction, errors.Wrap(err, "initTransactionID in TokenFreezeTransaction.FreezeWith")
	}
