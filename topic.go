...
func ParseLog(args *Type, log *Log) (map[string]interface{}, error) {
...
func ParseTopics(args *Type, topics []Hash) ([]interface{}, error) {
...
func ParseTopic(t *Type, topic Hash) (interface{}, error) {
	switch t.kind {
	case KindBool:
...
func EncodeTopic(t *Type, val interface{}) (Hash, error) {
	return encodeTopic(t, reflect.ValueOf(val))
}

func encodeTopic(t *Type, val reflect.Value) (Hash, error) {
	switch t.kind {
	case KindBool:
	...
	return Hash{}, fmt.Errorf("not found")
}

var topicTrue, topicFalse Hash
...
func encodeTopicAddress(val reflect.Value) (res Hash, err error) {
	var b []byte
...
// nolint
func encodeTopicNum(t *Type, val reflect.Value) (res Hash, err error) {
	var b []byte
	b, err = encodeNum(val)
	if err != nil {
		return
...
func encodeTopicBool(v reflect.Value) (res Hash, err error) {
	if v.Kind() != reflect.Bool {
		return Hash{}, encodeErr(v, "bool")
	}
	if v.Bool() {
