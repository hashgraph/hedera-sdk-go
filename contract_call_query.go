...
// NewContractCallQuery creates a ContractCallQuery transaction which can be used to construct and execute a
...
func (transaction *ContractCallQuery) SetContractID(id ContractID) *ContractCallQuery {
...
func (transaction *ContractCallQuery) SetGas(gas uint64) *ContractCallQuery {
...
func (transaction *ContractCallQuery) SetMaxResultSize(size uint64) *ContractCallQuery {
	transaction.pb.MaxResultSize = int64(size)
	return transaction
}

// SetFunction sets which function to call, and the ContractFunctionParams to pass to the function
func (transaction *ContractCallQuery) SetFunction(name string, params *ContractFunctionParams) *ContractCallQuery {
	if params == nil {
...
func (transaction *ContractCallQuery) Execute(client *Client) (ContractFunctionResult, error) {
...
func (transaction *ContractCallQuery) Cost(client *Client) (Hbar, error) {
...
func (transaction *ContractCallQuery) SetMaxQueryPayment(maxPayment Hbar) *ContractCallQuery {
	return &ContractCallQuery{*transaction.QueryBuilder.SetMaxQueryPayment(maxPayment), transaction.pb}
}

// SetQueryPayment sets the payment amount for this Query.
func (transaction *ContractCallQuery) SetQueryPayment(paymentAmount Hbar) *ContractCallQuery {
	return &ContractCallQuery{*transaction.QueryBuilder.SetQueryPayment(paymentAmount), transaction.pb}
}

// SetQueryPaymentTransaction sets the payment Transaction for this Query.
func (transaction *ContractCallQuery) SetQueryPaymentTransaction(tx Transaction) *ContractCallQuery {
	return &ContractCallQuery{*transaction.QueryBuilder.SetQueryPaymentTransaction(tx), transaction.pb}
}
