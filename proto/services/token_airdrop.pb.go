...
var file_token_airdrop_proto_goTypes = []interface{}{
...
func file_token_airdrop_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_token_airdrop_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenAirdropTransactionBody); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
