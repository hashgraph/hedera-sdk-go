...
var file_schedulable_transaction_body_proto_goTypes = []interface{}{
...
func file_schedulable_transaction_body_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_schedulable_transaction_body_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_schedulable_transaction_body_proto_msgTypes[0].OneofWrappers = []interface{}{
