...
var file_recordcache_proto_goTypes = []interface{}{
...
func file_recordcache_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_recordcache_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransactionRecordEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_recordcache_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransactionReceiptEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_recordcache_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransactionReceiptEntries); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
