...
var file_token_pause_proto_rawDesc = []byte{
	0x0a, 0x11, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x70, 0x61, 0x75, 0x73, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x62, 0x61, 0x73, 0x69,
	0x63, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a,
	0x19, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x75, 0x73, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73,
...
var (
	...
	file_token_pause_proto_rawDescData = file_token_pause_proto_rawDesc
)

func file_token_pause_proto_rawDescGZIP() []byte {
	file_token_pause_proto_rawDescOnce.Do(func() {
		file_token_pause_proto_rawDescData = protoimpl.X.CompressGZIP(file_token_pause_proto_rawDescData)
	})
	return file_token_pause_proto_rawDescData
}

var file_token_pause_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_token_pause_proto_goTypes = []interface{}{
...
func file_token_pause_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_token_pause_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_token_pause_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_token_pause_proto_rawDesc = nil
