...
// 	protoc        v3.17.3
// source: proto/TokenGetAccountNftInfos.proto
...
func (x *TokenGetAccountNftInfosQuery) Reset() {
	*x = TokenGetAccountNftInfosQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_TokenGetAccountNftInfos_proto_msgTypes[0]
...
func (*TokenGetAccountNftInfosQuery) Descriptor() ([]byte, []int) {
	return file_proto_TokenGetAccountNftInfos_proto_rawDescGZIP(), []int{0}
}
...
func (x *TokenGetAccountNftInfosResponse) Reset() {
	*x = TokenGetAccountNftInfosResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_TokenGetAccountNftInfos_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TokenGetAccountNftInfosResponse) Descriptor() ([]byte, []int) {
	return file_proto_TokenGetAccountNftInfos_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_TokenGetAccountNftInfos_proto protoreflect.FileDescriptor

var file_proto_TokenGetAccountNftInfos_proto_rawDesc = []byte{
	0x0a, 0x23, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x66, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x2e,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa2, 0x01, 0x0a, 0x1c, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x66, 0x74, 0x49, 0x6e, 0x66,
	0x6f, 0x73, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x2a, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65,
	...
	0x74, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x6e, 0x64,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0x79, 0x0a, 0x1f, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x66,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d,
	...
	0x04, 0x6e, 0x66, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70, 0x72,
...
var (
	file_proto_TokenGetAccountNftInfos_proto_rawDescOnce sync.Once
	file_proto_TokenGetAccountNftInfos_proto_rawDescData = file_proto_TokenGetAccountNftInfos_proto_rawDesc
)

func file_proto_TokenGetAccountNftInfos_proto_rawDescGZIP() []byte {
	file_proto_TokenGetAccountNftInfos_proto_rawDescOnce.Do(func() {
		file_proto_TokenGetAccountNftInfos_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_TokenGetAccountNftInfos_proto_rawDescData)
	})
	return file_proto_TokenGetAccountNftInfos_proto_rawDescData
}

var file_proto_TokenGetAccountNftInfos_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_TokenGetAccountNftInfos_proto_goTypes = []interface{}{
...
var file_proto_TokenGetAccountNftInfos_proto_depIdxs = []int32{
...
func init() { file_proto_TokenGetAccountNftInfos_proto_init() }
func file_proto_TokenGetAccountNftInfos_proto_init() {
	if File_proto_TokenGetAccountNftInfos_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_TokenGetAccountNftInfos_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_TokenGetAccountNftInfos_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_TokenGetAccountNftInfos_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_TokenGetAccountNftInfos_proto_goTypes,
		DependencyIndexes: file_proto_TokenGetAccountNftInfos_proto_depIdxs,
		MessageInfos:      file_proto_TokenGetAccountNftInfos_proto_msgTypes,
	}.Build()
	File_proto_TokenGetAccountNftInfos_proto = out.File
	file_proto_TokenGetAccountNftInfos_proto_rawDesc = nil
	file_proto_TokenGetAccountNftInfos_proto_goTypes = nil
	file_proto_TokenGetAccountNftInfos_proto_depIdxs = nil
}
