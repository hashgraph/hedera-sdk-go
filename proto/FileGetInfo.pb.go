...
type FileGetInfoResponse struct {
	...
	FileInfo *FileGetInfoResponse_FileInfo `protobuf:"bytes,2,opt,name=fileInfo,proto3" json:"fileInfo,omitempty"` // The information about the file (a state proof can be generated for this)
}
...
var file_proto_FileGetInfo_proto_rawDesc = []byte{
	...
	0x65, 0x79, 0x73, 0x42, 0x48, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65, 0x72,
