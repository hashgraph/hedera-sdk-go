...
type AccountAmount struct {
	...
	AccountID *AccountID `protobuf:"bytes,1,opt,name=accountID,proto3" json:"accountID,omitempty"` // The Account ID that sends or receives cryptocurrency
	Amount    int64      `protobuf:"zigzag64,2,opt,name=amount,proto3" json:"amount,omitempty"`    // The amount of tinybars that the account sends(negative) or receives(positive)
}
...
func (x *CryptoTransferTransactionBody) Reset() {
	*x = CryptoTransferTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_CryptoTransfer_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CryptoTransferTransactionBody) Descriptor() ([]byte, []int) {
	return file_proto_CryptoTransfer_proto_rawDescGZIP(), []int{2}
}
...
var file_proto_CryptoTransfer_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x42, 0x48, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65,
...
var file_proto_CryptoTransfer_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_CryptoTransfer_proto_goTypes = []interface{}{
	(*AccountAmount)(nil),                 // 0: proto.AccountAmount
	(*TransferList)(nil),                  // 1: proto.TransferList
	(*CryptoTransferTransactionBody)(nil), // 2: proto.CryptoTransferTransactionBody
	(*AccountID)(nil),                     // 3: proto.AccountID
}
var file_proto_CryptoTransfer_proto_depIdxs = []int32{
	3, // 0: proto.AccountAmount.accountID:type_name -> proto.AccountID
	0, // 1: proto.TransferList.accountAmounts:type_name -> proto.AccountAmount
	1, // 2: proto.CryptoTransferTransactionBody.transfers:type_name -> proto.TransferList
...
func file_proto_CryptoTransfer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_CryptoTransfer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
