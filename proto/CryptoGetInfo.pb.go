...
func (*TokenRelationship) Descriptor() ([]byte, []int) {
	return file_proto_CryptoGetInfo_proto_rawDescGZIP(), []int{2}
}
...
func (x *CryptoGetInfoResponse_AccountInfo) Reset() {
	*x = CryptoGetInfoResponse_AccountInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_CryptoGetInfo_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_proto_CryptoGetInfo_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x68, 0x69, 0x70, 0x73, 0x22, 0xe2, 0x01, 0x0a, 0x11, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x72, 0x65, 0x65, 0x7a, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x4a, 0x0a, 0x22, 0x63,
...
var file_proto_CryptoGetInfo_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_CryptoGetInfo_proto_goTypes = []interface{}{
	...
	(*TokenRelationship)(nil),                 // 2: proto.TokenRelationship
	(*CryptoGetInfoResponse_AccountInfo)(nil), // 3: proto.CryptoGetInfoResponse.AccountInfo
	...
	(TokenFreezeStatus)(0),                    // 9: proto.TokenFreezeStatus
	(*Key)(nil),                               // 10: proto.Key
	(*Timestamp)(nil),                         // 11: proto.Timestamp
	(*Duration)(nil),                          // 12: proto.Duration
	(*LiveHash)(nil),                          // 13: proto.LiveHash
}
var file_proto_CryptoGetInfo_proto_depIdxs = []int32{
	4,  // 0: proto.CryptoGetInfoQuery.header:type_name -> proto.QueryHeader
	5,  // 1: proto.CryptoGetInfoQuery.accountID:type_name -> proto.AccountID
	6,  // 2: proto.CryptoGetInfoResponse.header:type_name -> proto.ResponseHeader
	3,  // 3: proto.CryptoGetInfoResponse.accountInfo:type_name -> proto.CryptoGetInfoResponse.AccountInfo
	7,  // 4: proto.TokenRelationship.tokenId:type_name -> proto.TokenID
	8,  // 5: proto.TokenRelationship.kycStatus:type_name -> proto.TokenKycStatus
	9,  // 6: proto.TokenRelationship.freezeStatus:type_name -> proto.TokenFreezeStatus
	5,  // 7: proto.CryptoGetInfoResponse.AccountInfo.accountID:type_name -> proto.AccountID
	5,  // 8: proto.CryptoGetInfoResponse.AccountInfo.proxyAccountID:type_name -> proto.AccountID
	10, // 9: proto.CryptoGetInfoResponse.AccountInfo.key:type_name -> proto.Key
	11, // 10: proto.CryptoGetInfoResponse.AccountInfo.expirationTime:type_name -> proto.Timestamp
	12, // 11: proto.CryptoGetInfoResponse.AccountInfo.autoRenewPeriod:type_name -> proto.Duration
	13, // 12: proto.CryptoGetInfoResponse.AccountInfo.liveHashes:type_name -> proto.LiveHash
	2,  // 13: proto.CryptoGetInfoResponse.AccountInfo.tokenRelationships:type_name -> proto.TokenRelationship
...
func file_proto_CryptoGetInfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_CryptoGetInfo_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
