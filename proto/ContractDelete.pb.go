...
type ContractDeleteTransactionBody struct {
	...
	ContractID *ContractID `protobuf:"bytes,1,opt,name=contractID,proto3" json:"contractID,omitempty"` // The Contract ID instance to delete (this can't be changed)
...
type ContractDeleteTransactionBody_TransferAccountID struct {
	TransferAccountID *AccountID `protobuf:"bytes,2,opt,name=transferAccountID,proto3,oneof"` // The account ID which will receive all remaining hbars
}

type ContractDeleteTransactionBody_TransferContractID struct {
	TransferContractID *ContractID `protobuf:"bytes,3,opt,name=transferContractID,proto3,oneof"` // The contract ID which will receive all remaining hbars
}
...
var file_proto_ContractDelete_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x72, 0x73, 0x42, 0x48, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65,
