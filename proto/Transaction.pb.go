...
type Transaction struct {
	...
	// Types that are assignable to BodyData:
	//	*Transaction_Body
...
func (x *Transaction) GetBody() *TransactionBody {
	if x, ok := x.GetBodyData().(*Transaction_Body); ok {
		return x.Body
	}
	return nil
}
...
func (x *Transaction) GetBodyBytes() []byte {
	if x, ok := x.GetBodyData().(*Transaction_BodyBytes); ok {
		return x.BodyBytes
	}
	return nil
}
...
type Transaction_Body struct {
	// Deprecated: Do not use.
	Body *TransactionBody `protobuf:"bytes,1,opt,name=body,proto3,oneof"` // the body of the transaction, which needs to be signed
}

type Transaction_BodyBytes struct {
	BodyBytes []byte `protobuf:"bytes,4,opt,name=bodyBytes,proto3,oneof"` // TransactionBody serialized into bytes , which needs to be signed
}
...
var file_proto_Transaction_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x70, 0x42, 0x0a, 0x0a, 0x08, 0x62, 0x6f, 0x64, 0x79, 0x44, 0x61, 0x74, 0x61, 0x42, 0x48,
...
func file_proto_Transaction_proto_init() {
	...
	file_proto_Transaction_proto_msgTypes[0].OneofWrappers = []interface{}{
