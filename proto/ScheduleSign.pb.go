...
type ScheduleSignTransactionBody struct {
	...
	SigMap     *SignatureMap `protobuf:"bytes,2,opt,name=sigMap,proto3" json:"sigMap,omitempty"`         // The signature map containing the signature(s) to authorise the transaction
}
...
func (x *ScheduleSignTransactionBody) GetSigMap() *SignatureMap {
	if x != nil {
		return x.SigMap
	}
	return nil
...
var file_proto_ScheduleSign_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7d, 0x0a, 0x1b, 0x53, 0x63, 0x68,
	...
	0x0a, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x49, 0x44, 0x12, 0x2b, 0x0a, 0x06, 0x73,
	0x69, 0x67, 0x4d, 0x61, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x4d, 0x61, 0x70,
	0x52, 0x06, 0x73, 0x69, 0x67, 0x4d, 0x61, 0x70, 0x42, 0x50, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_proto_ScheduleSign_proto_goTypes = []interface{}{
	...
	(*SignatureMap)(nil),                // 2: proto.SignatureMap
}
var file_proto_ScheduleSign_proto_depIdxs = []int32{
	...
	2, // 1: proto.ScheduleSignTransactionBody.sigMap:type_name -> proto.SignatureMap
