...
// 	protoc        v3.17.3
// source: proto/crypto_get_live_hash.proto
...
func (x *CryptoGetLiveHashQuery) Reset() {
	*x = CryptoGetLiveHashQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_crypto_get_live_hash_proto_msgTypes[0]
...
func (*CryptoGetLiveHashQuery) Descriptor() ([]byte, []int) {
	return file_proto_crypto_get_live_hash_proto_rawDescGZIP(), []int{0}
}
...
func (x *CryptoGetLiveHashResponse) Reset() {
	*x = CryptoGetLiveHashResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_crypto_get_live_hash_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CryptoGetLiveHashResponse) Descriptor() ([]byte, []int) {
	return file_proto_crypto_get_live_hash_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_crypto_get_live_hash_proto protoreflect.FileDescriptor

var file_proto_crypto_get_live_hash_proto_rawDesc = []byte{
	0x0a, 0x20, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5f, 0x67,
	0x65, 0x74, 0x5f, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x20, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5f, 0x61, 0x64, 0x64, 0x5f, 0x6c, 0x69, 0x76, 0x65,
	0x5f, 0x68, 0x61, 0x73, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x16,
	0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73,
	0x68, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x2a, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	...
	0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x77, 0x0a, 0x19, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f,
	...
	0x65, 0x72, 0x12, 0x2b, 0x0a, 0x08, 0x6c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x69, 0x76,
	0x65, 0x48, 0x61, 0x73, 0x68, 0x52, 0x08, 0x6c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x42,
...
var (
	file_proto_crypto_get_live_hash_proto_rawDescOnce sync.Once
	file_proto_crypto_get_live_hash_proto_rawDescData = file_proto_crypto_get_live_hash_proto_rawDesc
)

func file_proto_crypto_get_live_hash_proto_rawDescGZIP() []byte {
	file_proto_crypto_get_live_hash_proto_rawDescOnce.Do(func() {
		file_proto_crypto_get_live_hash_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_crypto_get_live_hash_proto_rawDescData)
	})
	return file_proto_crypto_get_live_hash_proto_rawDescData
}

var file_proto_crypto_get_live_hash_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_crypto_get_live_hash_proto_goTypes = []interface{}{
...
var file_proto_crypto_get_live_hash_proto_depIdxs = []int32{
...
func init() { file_proto_crypto_get_live_hash_proto_init() }
func file_proto_crypto_get_live_hash_proto_init() {
	if File_proto_crypto_get_live_hash_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_crypto_get_live_hash_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_crypto_get_live_hash_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_crypto_get_live_hash_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_crypto_get_live_hash_proto_goTypes,
		DependencyIndexes: file_proto_crypto_get_live_hash_proto_depIdxs,
		MessageInfos:      file_proto_crypto_get_live_hash_proto_msgTypes,
	}.Build()
	File_proto_crypto_get_live_hash_proto = out.File
	file_proto_crypto_get_live_hash_proto_rawDesc = nil
	file_proto_crypto_get_live_hash_proto_goTypes = nil
	file_proto_crypto_get_live_hash_proto_depIdxs = nil
}
