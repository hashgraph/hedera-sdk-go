...
type ConsensusTopicQuery struct {
	...
	TopicID *hedera_sdk_go.TopicID `protobuf:"bytes,1,opt,name=topicID,proto3" json:"topicID,omitempty"` // A required topic ID to retrieve messages for.
	// Include messages which reached consensus on or after this time. Defaults to current time if not set.
	ConsensusStartTime *hedera_sdk_go.Timestamp `protobuf:"bytes,2,opt,name=consensusStartTime,proto3" json:"consensusStartTime,omitempty"`
	// Include messages which reached consensus before this time. If not set it will receive indefinitely.
	ConsensusEndTime *hedera_sdk_go.Timestamp `protobuf:"bytes,3,opt,name=consensusEndTime,proto3" json:"consensusEndTime,omitempty"`
...
func (x *ConsensusTopicQuery) GetTopicID() *hedera_sdk_go.TopicID {
	if x != nil {
		return x.TopicID
	}
	return nil
...
func (x *ConsensusTopicQuery) GetConsensusStartTime() *hedera_sdk_go.Timestamp {
	if x != nil {
...
func (x *ConsensusTopicQuery) GetConsensusEndTime() *hedera_sdk_go.Timestamp {
	if x != nil {
...
type ConsensusTopicResponse struct {
	...
	ConsensusTimestamp *hedera_sdk_go.Timestamp `protobuf:"bytes,1,opt,name=consensusTimestamp,proto3" json:"consensusTimestamp,omitempty"` // The time at which the transaction reached consensus
	...
	ChunkInfo          *hedera_sdk_go.ConsensusMessageChunkInfo `protobuf:"bytes,6,opt,name=chunkInfo,proto3" json:"chunkInfo,omitempty"`                    // Optional information of the current chunk in a fragmented message.
}
...
func (x *ConsensusTopicResponse) GetConsensusTimestamp() *hedera_sdk_go.Timestamp {
	if x != nil {
...
func (x *ConsensusTopicResponse) GetChunkInfo() *hedera_sdk_go.ConsensusMessageChunkInfo {
	if x != nil {
		return x.ChunkInfo
	}
	return nil
...
var file_proto_mirror_ConsensusService_proto_goTypes = []interface{}{
	...
	(*hedera_sdk_go.TopicID)(nil),                   // 2: proto.TopicID
	(*hedera_sdk_go.Timestamp)(nil),                 // 3: proto.Timestamp
	(*hedera_sdk_go.ConsensusMessageChunkInfo)(nil), // 4: proto.ConsensusMessageChunkInfo
}
