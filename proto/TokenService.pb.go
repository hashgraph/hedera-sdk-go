...
var file_proto_TokenService_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa6, 0x07, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
...
var file_proto_TokenService_proto_depIdxs = []int32{
	...
	0,  // 10: proto.TokenService.transferTokens:input_type -> proto.Transaction
	0,  // 11: proto.TokenService.associateTokens:input_type -> proto.Transaction
	0,  // 12: proto.TokenService.dissociateTokens:input_type -> proto.Transaction
	1,  // 13: proto.TokenService.getTokenInfo:input_type -> proto.Query
	2,  // 14: proto.TokenService.createToken:output_type -> proto.TransactionResponse
	2,  // 15: proto.TokenService.updateToken:output_type -> proto.TransactionResponse
	2,  // 16: proto.TokenService.mintToken:output_type -> proto.TransactionResponse
	2,  // 17: proto.TokenService.burnToken:output_type -> proto.TransactionResponse
	2,  // 18: proto.TokenService.deleteToken:output_type -> proto.TransactionResponse
	2,  // 19: proto.TokenService.wipeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 20: proto.TokenService.freezeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 21: proto.TokenService.unfreezeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 22: proto.TokenService.grantKycToTokenAccount:output_type -> proto.TransactionResponse
	2,  // 23: proto.TokenService.revokeKycFromTokenAccount:output_type -> proto.TransactionResponse
	2,  // 24: proto.TokenService.transferTokens:output_type -> proto.TransactionResponse
	2,  // 25: proto.TokenService.associateTokens:output_type -> proto.TransactionResponse
	2,  // 26: proto.TokenService.dissociateTokens:output_type -> proto.TransactionResponse
	3,  // 27: proto.TokenService.getTokenInfo:output_type -> proto.Response
...
func _TokenService_TransferTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(TokenServiceServer).TransferTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var _TokenService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TokenService_TransferTokens_Handler,
		},
		{
