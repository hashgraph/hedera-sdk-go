...
var file_proto_SmartContractService_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x46, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65, 0x72, 0x61, 0x2e,
...
var (
	file_proto_SmartContractService_proto_rawDescOnce sync.Once
	file_proto_SmartContractService_proto_rawDescData = file_proto_SmartContractService_proto_rawDesc
)

func file_proto_SmartContractService_proto_rawDescGZIP() []byte {
	file_proto_SmartContractService_proto_rawDescOnce.Do(func() {
		file_proto_SmartContractService_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_SmartContractService_proto_rawDescData)
	})
	return file_proto_SmartContractService_proto_rawDescData
}
