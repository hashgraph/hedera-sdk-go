...
type ConsensusUpdateTopicTransactionBody struct {
	...
	Memo    *StringValue `protobuf:"bytes,2,opt,name=memo,proto3" json:"memo,omitempty"` // If set, the new memo to be associated with the topic (UTF-8 encoding max 100 bytes)
